    ...
    <div class="grid grid-cols-4 gap-7">
            ...
            >
              ...
              <div class="p-5">
                ...
                >
                  ...
                  >
                    <span class="hover:border-gray-600 hover:border-b-2">{{
                      article.title
                    }}</span>
                  </h2>
                </a>
                ...
                >
                  ...
                  <a
                    ...
                    "
                    class="cursor-pointer text-gray-400 hover:underline transition-colors duration-200"
      ...
      >
        <div class="sticky top-[5.5rem]">
          ...
          <!-- 聊天室入口 -->
          <div
            @click="jump2ChatRoomPage"
            class="group w-full py-5 px-4 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow"
          >
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <!-- 聊天图标 -->
                <div
                  class="w-10 h-10 rounded-full bg-sky-100 dark:bg-sky-900 flex items-center justify-center"
                >
                  <svg
                    t="1768296965309"
              ...
              <!-- 箭头 -->
              <svg
                class="w-3 h-3 text-gray-400 dark:text-white transition-transform duration-300 group-hover:translate-x-1"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 8 14"
...
function getArticles(currentNo) {
  ...
  // 调用分页接口渲染数据
  getArticlePageList({ current: currentNo, size: size.value })
    .then((res) => {
      if (res.success) {
