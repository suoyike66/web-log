    ...
    <div>
        ...
        <el-card shadow="never" class="mb-5">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 w-52 mr-5"><el-input v-model="queryParams.name" placeholder="请输入（模糊查询）" /></div>
        ...
        <el-card shadow="never">
            ...
            <div v-if="!tableLoading">
                <el-table :data="tableData" border stripe style="width: 100%" class="animate__animated animate__fadeIn">
                    ...
                    <el-table-column label="操作">
                        <template #default="scope">
                            <el-button type="danger" size="small" @click="deleteTagSubmit(scope.row)" :loading="deleteLoading">
                                <el-icon class="mr-1">
                                    <Delete />
                                </el-icon>
                                删除
...
// 删除请求逻辑
const { execute: executeDelete, loading: deleteLoading } = useRequest(deleteTag)
