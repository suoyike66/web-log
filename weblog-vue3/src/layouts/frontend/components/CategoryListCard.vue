<template>
    <div v-if="categories.length > 1" class="w-full p-5 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow">
        <!-- 分类标题 -->
        <h2 class="flex items-center mb-2 font-bold text-gray-900 uppercase dark:text-white" @click="goCategoryListPage">
            <!-- 文件夹图标 -->
