<template>
    <div v-if="tags.length > 1" class="w-full p-5 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow">
        <!-- 标签标题 -->
        <h2 class="flex items-center mb-2 font-bold text-gray-900 uppercase dark:text-white" @click="goTagListPage">
            <!-- 标签图标 -->
