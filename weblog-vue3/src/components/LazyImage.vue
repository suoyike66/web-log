  ...
  <div class="lazy-image-container" :style="containerStyle">
    ...
    <div v-else-if="error" class="lazy-image-error" :style="placeholderStyle">
      <div class="lazy-image-error-content">
        ...
        <button
          class="mt-4 text-sm text-blue-500 hover:text-blue-700"
          @click="retryLoad"
        >
          重试
        </button>
...
const props = defineProps({
  ...
  defaultSrc: {
    type: String,
    default:
      'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=minimal%20abstract%20geometric%20pattern%20background%20in%20neutral%20colors&image_size=square',
  },
});
