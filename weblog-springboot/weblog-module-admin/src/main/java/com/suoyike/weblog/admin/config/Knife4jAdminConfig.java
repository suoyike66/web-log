...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.suoyike.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.suoyike.com/") // API 服务条款
                .contact(new Contact("蓑衣客", "https://www.suoyike.com", "3590646448@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}
